...
auth_channel = environ.get('-1001443092127')
auth_grp = environ.get('@movie01request')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001977482249')
reqst_channel = environ.get('REQST_CHANNEL', '-1001977482249')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://copycatzero1:UTnD2gMumCwmNDNV@copycat.u4rls.mongodb.net/?retryWrites=true&w=majority&appName=copycat")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movie01request')
...
URL = "https://https://captain-r73r.onrender.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://mytestvj-998c9929dc7a.herokuapp.com/".format(FQDN, PORT)

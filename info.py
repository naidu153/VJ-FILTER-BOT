...
API_ID = int(environ.get('API_ID', '29212217'))
API_HASH = environ.get('API_HASH', '46d916225575d23af987ea024a31565b')
BOT_TOKEN = environ.get('6568542387:AAECbjE59pBPHiFOsNhRuuaOEu1gqpapG40', "")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6619548883').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002108816583').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002111699498'))
